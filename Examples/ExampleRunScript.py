...
# ==============================================================================
options = {"outputDir": "ExampleOutput", "outputFormat": ".vtu"}
...
# ==============================================================================
for problem in model.problems:
    value = problem.computeFunction("Mass", elementReductionType="integrate", globalReductionType="average")
    print("testing compute function: Mass = ", value)
