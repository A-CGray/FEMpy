...
class LinAlgUnitTest(unittest.TestCase):
    ...
    def test1DDet(self):
        ...
        np.testing.assert_allclose(
            det1(self.Mats[0]),
            np.linalg.det(self.Mats[0]),
            atol=10.0 ** (-self.precision),
        )
